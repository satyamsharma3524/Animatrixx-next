...
export default function MyListPage() {
  // In a real app, you would fetch user's saved content from an API
  const savedContent = {
    anime: [
      {
        id: 1,
        ...
        <div className="container px-4 py-8">
          ...
          <Tabs defaultValue="all" className="mb-8">
            <TabsList className="bg-zinc-900 border-b border-zinc-800 p-0 h-auto w-full justify-start rounded-none">
              ...
              >
                All ({savedContent.anime.length + savedContent.manga.length})
              </TabsTrigger>
              <TabsTrigger
                value="anime"
                className="py-3 px-6 rounded-none data-[state=active]:bg-transparent data-[state=active]:border-b-2 data-[state=active]:border-pink-500 data-[state=active]:shadow-none"
              >
                Anime ({savedContent.anime.length})
              </TabsTrigger>
              <TabsTrigger
                value="manga"
                className="py-3 px-6 rounded-none data-[state=active]:bg-transparent data-[state=active]:border-b-2 data-[state=active]:border-pink-500 data-[state=active]:shadow-none"
              >
                Manga ({savedContent.manga.length})
              </TabsTrigger>
            </TabsList>

            <TabsContent value="all" className="mt-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
                {[...savedContent.anime, ...savedContent.manga].map((item) => (
